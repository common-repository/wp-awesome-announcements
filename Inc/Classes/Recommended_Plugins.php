	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. wp-awesome-announcements-settings /  edit.php?post_type=page .
				__( 'Recommended', 'wp-awesome-announcements' ),
				__( 'Recommended', 'wp-awesome-announcements' ),
				'manage_options',
				'wp-awesome-announcements-recommended-plugins',
